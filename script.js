...
// ===== ZARF AÇMA – KESİN ÇÖZÜM (click + touchstart) =====
let opened = false;

function openEnvelope(e) {
    e.preventDefault(); // Mobilde scroll'u engelle
    if (!opened) {
        envelope.classList.add('open');
        opened = true;
        hint.textContent = '❤️ Mektubu okudun mu?';
        hint.style.color = '#ffb3c6';
        // 4.5 saniye sonra uzak mesafe bölümüne geç
        setTimeout(() => goToSection(3), 4500);
    }
}

// Hem click hem touchstart ile yakala
...
// Başlangıçta intro bölümü aktif
goToSection(0);